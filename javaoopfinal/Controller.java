...
public class Controller {
    ...
    public void buttonClick() {
        ...
        try {
            Complex c1 = new Complex(view.inputValue("Введите вещественную часть: "), view.inputValue("Введите мнимую часть: "));

            char operation = view.inputOperationSign("Введите действия: +, -, *, /:  ");

            Complex c2 = new Complex(view.inputValue("Введите вещественную часть: "), view.inputValue("Введите мнимую часть: "));
            ...
            switch (operation) {
                ...
                default -> logger.log(Level.WARNING, "Ошибка ввода: " + operation);
            }
            fileHandler.close();
